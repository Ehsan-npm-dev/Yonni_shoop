...
function LinkMol() {
  return (
    <section className=" flex justify-around gap-24  sm:flex-wrap sm:justify-center sm:items-center py-9">
      <div className="sec-low ">
        <ul className="wet">
          <li className=""> <Link className="text-black p-2">راهنمای خرید</Link> </li>
